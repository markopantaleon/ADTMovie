...
const Form = () => {
  ...
  const photosToShow = 5; // Number of photos to show at once

  const handlePrev = () => {
    setCurrentIndex((prevIndex) =>
      prevIndex === 0 ? photos.length - photosToShow : prevIndex - photosToShow
    );
  };

  const handleNext = () => {
    setCurrentIndex((prevIndex) =>
      prevIndex >= photos.length - photosToShow ? 0 : prevIndex + photosToShow
    );
  };
              ...
              <div className="movie-details">
                ...
                <div className="button-container">
                  ...
                  <button
                    className="cancel"
                    type="button"
                    onClick={() => navigate("/main/movies/home")}
                    disabled={isLoading}
                  >
                    Cancel
                  </button>
